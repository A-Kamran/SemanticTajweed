 ...
 * Source Class: Chapter <br>
 * @version generated on Tue Dec 31 23:36:31 PKT 2024 by amna
 */

public interface Chapter extends WrappedIndividual {
    ...
    /* ***************************************************
     * Property http://www.semantictajweed.com/ontology/hasVerse
     */
     
    /**
     * Gets all property values for the hasVerse property.<p>
     * 
     * @returns a collection of values for the hasVerse property.
     */
    Collection<? extends Verse> getHasVerse();

    /**
     * Checks if the class has a hasVerse property value.<p>
     * 
     * @return true if there is a hasVerse property value.
     */
    boolean hasHasVerse();

    /**
     * Adds a hasVerse property value.<p>
     * 
     * @param newHasVerse the hasVerse property value to be added
     */
    void addHasVerse(Verse newHasVerse);

    /**
     * Removes a hasVerse property value.<p>
     * 
     * @param oldHasVerse the hasVerse property value to be removed.
     */
    void removeHasVerse(Verse oldHasVerse);
