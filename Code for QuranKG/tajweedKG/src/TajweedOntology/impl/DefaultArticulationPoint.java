 ...
 * Source Class: DefaultArticulationPoint <br>
 * @version generated on Tue Dec 31 23:36:31 PKT 2024 by amna
 */
public class DefaultArticulationPoint extends WrappedIndividualImpl implements ArticulationPoint {

    public DefaultArticulationPoint(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    public Collection<? extends ArticulationPoint> getInvolvesAnatomicalUnit() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_INVOLVESANATOMICALUNIT,
                                               DefaultArticulationPoint.class);
    }

    public boolean hasInvolvesAnatomicalUnit() {
	   return !getInvolvesAnatomicalUnit().isEmpty();
    }

    public void addInvolvesAnatomicalUnit(ArticulationPoint newInvolvesAnatomicalUnit) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_INVOLVESANATOMICALUNIT,
                                       newInvolvesAnatomicalUnit);
    }

    public void removeInvolvesAnatomicalUnit(ArticulationPoint oldInvolvesAnatomicalUnit) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_INVOLVESANATOMICALUNIT,
                                          oldInvolvesAnatomicalUnit);
    }
    ...
    public Collection<? extends Letter> getIsArticulationPointof() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_ISARTICULATIONPOINTOF,
                                               DefaultLetter.class);
    }

    public boolean hasIsArticulationPointof() {
	   return !getIsArticulationPointof().isEmpty();
    }

    public void addIsArticulationPointof(Letter newIsArticulationPointof) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_ISARTICULATIONPOINTOF,
                                       newIsArticulationPointof);
    }

    public void removeIsArticulationPointof(Letter oldIsArticulationPointof) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_ISARTICULATIONPOINTOF,
                                          oldIsArticulationPointof);
    }
