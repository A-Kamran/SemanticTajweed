...
public class DefaultLetterOccurrence extends WrappedIndividualImpl implements LetterOccurrence {
    ...
    public Collection<? extends WrappedIndividual> getInvolvesLetter() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_INVOLVESLETTER,
                                               WrappedIndividualImpl.class);
    }

    public boolean hasInvolvesLetter() {
	   return !getInvolvesLetter().isEmpty();
    }

    public void addInvolvesLetter(WrappedIndividual newInvolvesLetter) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_INVOLVESLETTER,
                                       newInvolvesLetter);
    }

    public void removeInvolvesLetter(WrappedIndividual oldInvolvesLetter) {
    ...
    public Collection<? extends WrappedIndividual> getIsPartOfWord() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_ISPARTOFWORD,
                                               WrappedIndividualImpl.class);
    }

    public boolean hasIsPartOfWord() {
	   return !getIsPartOfWord().isEmpty();
    }

    public void addIsPartOfWord(WrappedIndividual newIsPartOfWord) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_ISPARTOFWORD,
                                       newIsPartOfWord);
    }

    public void removeIsPartOfWord(WrappedIndividual oldIsPartOfWord) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_ISPARTOFWORD,
                                          oldIsPartOfWord);
    }
