 ...
 * Source Class: DefaultCharacteristicsWithOpposite <br>
 * @version generated on Tue Dec 31 23:36:31 PKT 2024 by amna
 */
public class DefaultCharacteristicsWithOpposite extends WrappedIndividualImpl implements CharacteristicsWithOpposite {

    public DefaultCharacteristicsWithOpposite(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    public Collection<? extends BasicCharacteristic> getHasCharacteristicType() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_HASCHARACTERISTICTYPE,
                                               DefaultBasicCharacteristic.class);
    }

    public boolean hasHasCharacteristicType() {
	   return !getHasCharacteristicType().isEmpty();
    }

    public void addHasCharacteristicType(BasicCharacteristic newHasCharacteristicType) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_HASCHARACTERISTICTYPE,
                                       newHasCharacteristicType);
    }

    public void removeHasCharacteristicType(BasicCharacteristic oldHasCharacteristicType) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_HASCHARACTERISTICTYPE,
                                          oldHasCharacteristicType);
    }
    ...
    public Collection<? extends Letter> getIsCharacteristicOf() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_ISCHARACTERISTICOF,
                                               DefaultLetter.class);
    }

    public boolean hasIsCharacteristicOf() {
	   return !getIsCharacteristicOf().isEmpty();
    }

    public void addIsCharacteristicOf(Letter newIsCharacteristicOf) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_ISCHARACTERISTICOF,
                                       newIsCharacteristicOf);
    }

    public void removeIsCharacteristicOf(Letter oldIsCharacteristicOf) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_ISCHARACTERISTICOF,
                                          oldIsCharacteristicOf);
    }
    ...
    public Collection<? extends CharacteristicsWithOpposite> getIsOppositeOf() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_ISOPPOSITEOF,
                                               DefaultCharacteristicsWithOpposite.class);
    }

    public boolean hasIsOppositeOf() {
	   return !getIsOppositeOf().isEmpty();
    }

    public void addIsOppositeOf(CharacteristicsWithOpposite newIsOppositeOf) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_ISOPPOSITEOF,
                                       newIsOppositeOf);
    }

    public void removeIsOppositeOf(CharacteristicsWithOpposite oldIsOppositeOf) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_ISOPPOSITEOF,
                                          oldIsOppositeOf);
    }
    ...
    public Collection<? extends CharacteristicsWithOpposite> getPartiallyInvolves() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_PARTIALLYINVOLVES,
                                               DefaultCharacteristicsWithOpposite.class);
    }

    public boolean hasPartiallyInvolves() {
	   return !getPartiallyInvolves().isEmpty();
    }

    public void addPartiallyInvolves(CharacteristicsWithOpposite newPartiallyInvolves) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_PARTIALLYINVOLVES,
                                       newPartiallyInvolves);
    }

    public void removePartiallyInvolves(CharacteristicsWithOpposite oldPartiallyInvolves) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_PARTIALLYINVOLVES,
                                          oldPartiallyInvolves);
    }
