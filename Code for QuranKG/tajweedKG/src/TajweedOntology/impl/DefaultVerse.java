...
public class DefaultVerse extends WrappedIndividualImpl implements Verse {
    ...
    public Collection<? extends WrappedIndividual> getHasWord() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_HASWORD,
                                               WrappedIndividualImpl.class);
    }

    public boolean hasHasWord() {
	   return !getHasWord().isEmpty();
    }

    public void addHasWord(WrappedIndividual newHasWord) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_HASWORD,
                                       newHasWord);
    }

    public void removeHasWord(WrappedIndividual oldHasWord) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_HASWORD,
                                          oldHasWord);
    }
    ...
    public Collection<? extends Chapter> getIsPartOfChapter() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_ISPARTOFCHAPTER,
                                               DefaultChapter.class);
    }
    ...
    public void addIsPartOfChapter(Chapter newIsPartOfChapter) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_ISPARTOFCHAPTER,
                                       newIsPartOfChapter);
    }

    public void removeIsPartOfChapter(Chapter oldIsPartOfChapter) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_ISPARTOFCHAPTER,
                                          oldIsPartOfChapter);
    }
