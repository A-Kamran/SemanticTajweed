...
public class DefaultWord extends WrappedIndividualImpl implements Word {
    ...
    public Collection<? extends Letter> getHasLetter() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_HASLETTER,
                                               DefaultLetter.class);
    }

    public boolean hasHasLetter() {
	   return !getHasLetter().isEmpty();
    }

    public void addHasLetter(Letter newHasLetter) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_HASLETTER,
                                       newHasLetter);
    }

    public void removeHasLetter(Letter oldHasLetter) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_HASLETTER,
                                          oldHasLetter);
    }
