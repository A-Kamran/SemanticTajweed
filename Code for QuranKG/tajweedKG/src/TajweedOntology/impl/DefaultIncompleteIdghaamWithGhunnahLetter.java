 ...
 * Source Class: DefaultIncompleteIdghaamWithGhunnahLetter <br>
 * @version generated on Tue Dec 31 23:36:33 PKT 2024 by amna
 */
public class DefaultIncompleteIdghaamWithGhunnahLetter extends WrappedIndividualImpl implements IncompleteIdghaamWithGhunnahLetter {

    public DefaultIncompleteIdghaamWithGhunnahLetter(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    public Collection<? extends Word> getBelongsToGroup() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_BELONGSTOGROUP,
                                               DefaultWord.class);
    }

    public boolean hasBelongsToGroup() {
	   return !getBelongsToGroup().isEmpty();
    }

    public void addBelongsToGroup(Word newBelongsToGroup) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_BELONGSTOGROUP,
                                       newBelongsToGroup);
    }

    public void removeBelongsToGroup(Word oldBelongsToGroup) {
    ...
    public Collection<? extends Word> getComposesWord() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_COMPOSESWORD,
                                               DefaultWord.class);
    }

    public boolean hasComposesWord() {
	   return !getComposesWord().isEmpty();
    }

    public void addComposesWord(Word newComposesWord) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_COMPOSESWORD,
                                       newComposesWord);
    }

    public void removeComposesWord(Word oldComposesWord) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_COMPOSESWORD,
                                          oldComposesWord);
    }
    ...
    public Collection<? extends ArticulationPoint> getHasArticulationPoint() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_HASARTICULATIONPOINT,
                                               DefaultArticulationPoint.class);
    }

    public boolean hasHasArticulationPoint() {
	   return !getHasArticulationPoint().isEmpty();
    }

    public void addHasArticulationPoint(ArticulationPoint newHasArticulationPoint) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_HASARTICULATIONPOINT,
                                       newHasArticulationPoint);
    }

    public void removeHasArticulationPoint(ArticulationPoint oldHasArticulationPoint) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_HASARTICULATIONPOINT,
                                          oldHasArticulationPoint);
    }
    ...
    public Collection<? extends BasicCharacteristic> getHasCharacteristic() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
    ...
    public void addHasCharacteristic(BasicCharacteristic newHasCharacteristic) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_HASCHARACTERISTIC,
                                       newHasCharacteristic);
    }

    public void removeHasCharacteristic(BasicCharacteristic oldHasCharacteristic) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_HASCHARACTERISTIC,
