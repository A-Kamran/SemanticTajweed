 ...
 * Source Class: DefaultChapter <br>
 * @version generated on Tue Dec 31 23:36:31 PKT 2024 by amna
 */
public class DefaultChapter extends WrappedIndividualImpl implements Chapter {

    public DefaultChapter(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    public Collection<? extends Verse> getHasVerse() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_HASVERSE,
                                               DefaultVerse.class);
    }

    public boolean hasHasVerse() {
	   return !getHasVerse().isEmpty();
    }

    public void addHasVerse(Verse newHasVerse) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_HASVERSE,
                                       newHasVerse);
    }

    public void removeHasVerse(Verse oldHasVerse) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_HASVERSE,
                                          oldHasVerse);
    }
