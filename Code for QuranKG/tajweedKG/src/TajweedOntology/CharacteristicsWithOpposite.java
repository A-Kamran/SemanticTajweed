 ...
 * Source Class: CharacteristicsWithOpposite <br>
 * @version generated on Tue Dec 31 23:36:31 PKT 2024 by amna
 */

public interface CharacteristicsWithOpposite extends BasicCharacteristic {
    ...
    /* ***************************************************
     * Property http://www.semantictajweed.com/ontology/hasCharacteristicType
     */
     
    /**
     * Gets all property values for the hasCharacteristicType property.<p>
     * 
     * @returns a collection of values for the hasCharacteristicType property.
     */
    Collection<? extends BasicCharacteristic> getHasCharacteristicType();

    /**
     * Checks if the class has a hasCharacteristicType property value.<p>
     * 
     * @return true if there is a hasCharacteristicType property value.
     */
    boolean hasHasCharacteristicType();

    /**
     * Adds a hasCharacteristicType property value.<p>
     * 
     * @param newHasCharacteristicType the hasCharacteristicType property value to be added
     */
    void addHasCharacteristicType(BasicCharacteristic newHasCharacteristicType);

    /**
     * Removes a hasCharacteristicType property value.<p>
     * 
     * @param oldHasCharacteristicType the hasCharacteristicType property value to be removed.
     */
    void removeHasCharacteristicType(BasicCharacteristic oldHasCharacteristicType);
    ...
    /* ***************************************************
     * Property http://www.semantictajweed.com/ontology/isCharacteristicOf
     */
     
    /**
     * Gets all property values for the isCharacteristicOf property.<p>
     * 
     * @returns a collection of values for the isCharacteristicOf property.
     */
    Collection<? extends Letter> getIsCharacteristicOf();

    /**
     * Checks if the class has a isCharacteristicOf property value.<p>
     * 
     * @return true if there is a isCharacteristicOf property value.
     */
    boolean hasIsCharacteristicOf();

    /**
     * Adds a isCharacteristicOf property value.<p>
     * 
     * @param newIsCharacteristicOf the isCharacteristicOf property value to be added
     */
    void addIsCharacteristicOf(Letter newIsCharacteristicOf);

    /**
     * Removes a isCharacteristicOf property value.<p>
     * 
     * @param oldIsCharacteristicOf the isCharacteristicOf property value to be removed.
     */
    void removeIsCharacteristicOf(Letter oldIsCharacteristicOf);
    ...
    /* ***************************************************
     * Property http://www.semantictajweed.com/ontology/isOppositeOf
     */
     
    /**
     * Gets all property values for the isOppositeOf property.<p>
     * 
     * @returns a collection of values for the isOppositeOf property.
     */
    Collection<? extends CharacteristicsWithOpposite> getIsOppositeOf();

    /**
     * Checks if the class has a isOppositeOf property value.<p>
     * 
     * @return true if there is a isOppositeOf property value.
     */
    boolean hasIsOppositeOf();

    /**
     * Adds a isOppositeOf property value.<p>
     * 
     * @param newIsOppositeOf the isOppositeOf property value to be added
     */
    void addIsOppositeOf(CharacteristicsWithOpposite newIsOppositeOf);

    /**
     * Removes a isOppositeOf property value.<p>
     * 
     * @param oldIsOppositeOf the isOppositeOf property value to be removed.
     */
    void removeIsOppositeOf(CharacteristicsWithOpposite oldIsOppositeOf);
    ...
    /* ***************************************************
     * Property http://www.semantictajweed.com/ontology/partiallyInvolves
     */
     
    /**
     * Gets all property values for the partiallyInvolves property.<p>
     * 
     * @returns a collection of values for the partiallyInvolves property.
     */
    Collection<? extends CharacteristicsWithOpposite> getPartiallyInvolves();

    /**
     * Checks if the class has a partiallyInvolves property value.<p>
     * 
     * @return true if there is a partiallyInvolves property value.
     */
    boolean hasPartiallyInvolves();

    /**
     * Adds a partiallyInvolves property value.<p>
     * 
     * @param newPartiallyInvolves the partiallyInvolves property value to be added
     */
    void addPartiallyInvolves(CharacteristicsWithOpposite newPartiallyInvolves);

    /**
     * Removes a partiallyInvolves property value.<p>
     * 
     * @param oldPartiallyInvolves the partiallyInvolves property value to be removed.
     */
    void removePartiallyInvolves(CharacteristicsWithOpposite oldPartiallyInvolves);
