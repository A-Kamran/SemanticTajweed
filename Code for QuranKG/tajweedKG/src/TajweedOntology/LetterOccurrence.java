...
public interface LetterOccurrence extends WrappedIndividual {
    ...
    /* ***************************************************
     * Property http://www.semantictajweed.com/ontology/involvesLetter
     */
     
    /**
     * Gets all property values for the involvesLetter property.<p>
     * 
     * @returns a collection of values for the involvesLetter property.
     */
    Collection<? extends WrappedIndividual> getInvolvesLetter();

    /**
     * Checks if the class has a involvesLetter property value.<p>
     * 
     * @return true if there is a involvesLetter property value.
     */
    boolean hasInvolvesLetter();

    /**
     * Adds a involvesLetter property value.<p>
     * 
     * @param newInvolvesLetter the involvesLetter property value to be added
     */
    void addInvolvesLetter(WrappedIndividual newInvolvesLetter);

    /**
     * Removes a involvesLetter property value.<p>
     * 
     * @param oldInvolvesLetter the involvesLetter property value to be removed.
     */
    void removeInvolvesLetter(WrappedIndividual oldInvolvesLetter);
    ...
    /* ***************************************************
     * Property http://www.semantictajweed.com/ontology/isPartOfWord
     */
     
    /**
     * Gets all property values for the isPartOfWord property.<p>
     * 
     * @returns a collection of values for the isPartOfWord property.
     */
    Collection<? extends WrappedIndividual> getIsPartOfWord();

    /**
     * Checks if the class has a isPartOfWord property value.<p>
     * 
     * @return true if there is a isPartOfWord property value.
     */
    boolean hasIsPartOfWord();

    /**
     * Adds a isPartOfWord property value.<p>
     * 
     * @param newIsPartOfWord the isPartOfWord property value to be added
     */
    void addIsPartOfWord(WrappedIndividual newIsPartOfWord);

    /**
     * Removes a isPartOfWord property value.<p>
     * 
     * @param oldIsPartOfWord the isPartOfWord property value to be removed.
     */
    void removeIsPartOfWord(WrappedIndividual oldIsPartOfWord);
