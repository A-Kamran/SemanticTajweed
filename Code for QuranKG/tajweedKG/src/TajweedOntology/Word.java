...
public interface Word extends LexicalEntity, GroupOfLetters {
    ...
    /* ***************************************************
     * Property http://www.semantictajweed.com/ontology/hasLetter
     */
     
    /**
     * Gets all property values for the hasLetter property.<p>
     * 
     * @returns a collection of values for the hasLetter property.
     */
    Collection<? extends Letter> getHasLetter();

    /**
     * Checks if the class has a hasLetter property value.<p>
     * 
     * @return true if there is a hasLetter property value.
     */
    boolean hasHasLetter();

    /**
     * Adds a hasLetter property value.<p>
     * 
     * @param newHasLetter the hasLetter property value to be added
     */
    void addHasLetter(Letter newHasLetter);

    /**
     * Removes a hasLetter property value.<p>
     * 
     * @param oldHasLetter the hasLetter property value to be removed.
     */
    void removeHasLetter(Letter oldHasLetter);
