 ...
 * Source Class: ArticulationPoint <br>
 * @version generated on Tue Dec 31 23:36:31 PKT 2024 by amna
 */

public interface ArticulationPoint extends WrappedIndividual {
    ...
    /* ***************************************************
     * Property http://www.semantictajweed.com/ontology/involvesAnatomicalUnit
     */
     
    /**
     * Gets all property values for the involvesAnatomicalUnit property.<p>
     * 
     * @returns a collection of values for the involvesAnatomicalUnit property.
     */
    Collection<? extends ArticulationPoint> getInvolvesAnatomicalUnit();

    /**
     * Checks if the class has a involvesAnatomicalUnit property value.<p>
     * 
     * @return true if there is a involvesAnatomicalUnit property value.
     */
    boolean hasInvolvesAnatomicalUnit();

    /**
     * Adds a involvesAnatomicalUnit property value.<p>
     * 
     * @param newInvolvesAnatomicalUnit the involvesAnatomicalUnit property value to be added
     */
    void addInvolvesAnatomicalUnit(ArticulationPoint newInvolvesAnatomicalUnit);

    /**
     * Removes a involvesAnatomicalUnit property value.<p>
     * 
     * @param oldInvolvesAnatomicalUnit the involvesAnatomicalUnit property value to be removed.
     */
    void removeInvolvesAnatomicalUnit(ArticulationPoint oldInvolvesAnatomicalUnit);
    ...
    /* ***************************************************
     * Property http://www.semantictajweed.com/ontology/isArticulationPointof
     */
     
    /**
     * Gets all property values for the isArticulationPointof property.<p>
     * 
     * @returns a collection of values for the isArticulationPointof property.
     */
    Collection<? extends Letter> getIsArticulationPointof();

    /**
     * Checks if the class has a isArticulationPointof property value.<p>
     * 
     * @return true if there is a isArticulationPointof property value.
     */
    boolean hasIsArticulationPointof();

    /**
     * Adds a isArticulationPointof property value.<p>
     * 
     * @param newIsArticulationPointof the isArticulationPointof property value to be added
     */
    void addIsArticulationPointof(Letter newIsArticulationPointof);

    /**
     * Removes a isArticulationPointof property value.<p>
     * 
     * @param oldIsArticulationPointof the isArticulationPointof property value to be removed.
     */
    void removeIsArticulationPointof(Letter oldIsArticulationPointof);
